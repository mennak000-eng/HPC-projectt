...
- Docker Swarm was used to manage and orchestrate the Spark services across the cluster nodes.
...
- Conducted distributed bioinformatics analysis on gene expression datasets using PySpark.
## Findings
...
- Hardware limitations and service configuration issues required extensive troubleshooting during the cluster deployment process.
